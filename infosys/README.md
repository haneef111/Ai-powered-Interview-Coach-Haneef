...
## 🚨 IMPORTANT: Getting Zero Scores?

**If speech and facial scores show 0, you need FFmpeg!**

**Quick fix (5 minutes):**
```bash
check_ffmpeg.bat          # Check if installed
choco install ffmpeg      # Install (or use winget/manual)
...
**New users:** See `README_START_HERE.md` for the easiest way to get started!

**Having issues with 0 scores?** See `FIX_ZERO_SCORES_NOW.md`
...
### 🔴 Getting 0 Scores for Speech/Facial Analysis?

**Most common issue:** FFmpeg not installed
...
**Detailed guides:**
- `ZERO_SCORES_FIX.md` - Step-by-step fix
- `TROUBLESHOOTING_ZERO_SCORES.md` - Comprehensive troubleshooting
- `FIX_ERRORS_GUIDE.md` - Common errors and solutions
